    ...
    webdav.openModal = function () {
        ...
        if (!modal) {
            ...
            modal.innerHTML =
                ...
                + '<div class="col-md-9"><label class="form-label small">根目录</label><div class="input-group"><span class="input-group-text"><i class="bi bi-folder2-open"></i></span><input class="form-control" id="wdRoot" placeholder="/iptv-checker"></div></div>'
